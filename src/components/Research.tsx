...
export default function Research() {
    return (
        <section id="research" className="py-24 px-6 md:px-12 lg:px-24 bg-[var(--bg-primary)] text-[var(--text-primary)] transition-colors duration-500">
            <div className="max-w-7xl mx-auto">
                <motion.div
                    initial={{ opacity: 0, scale: 0.95 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    className="bg-[var(--bg-secondary)] border border-[var(--border-primary)] p-8 md:p-12 rounded-3xl relative overflow-hidden transition-colors duration-500"
                >
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
                        ...
                        <a
                            ...
                            className="flex items-center gap-2 bg-[var(--text-primary)] text-[var(--bg-primary)] px-8 py-4 rounded-full font-bold hover:scale-105 transition-transform"
                        >
                            Read Paper
